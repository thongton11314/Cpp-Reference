...
void StoreManager::buildCustomersFromFile(ifstream &inFile) {
...
void StoreManager::buildMoviesFromFile(ifstream &inFile) {
    // read until the end of file
...
void StoreManager::processCommandsFromFile(ifstream &inFile) {
